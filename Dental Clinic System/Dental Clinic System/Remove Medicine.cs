...
{
    public partial class Remove_Medicine : Form
    {
        ...
        private void Remove_Medicine_Load(object sender, EventArgs e)
        {
            ItemNo.Items.Clear();
            connection.Open();
        ...
        {
            connection.Open();
            SqlCommand com = new SqlCommand("Delete from StockTable where ItemNo = '" + ItemNo.SelectedItem.ToString() + "'", connection);
            com.ExecuteNonQuery();
